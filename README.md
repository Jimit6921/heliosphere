...
- Once installation is finished, you can find heliosphere in your Start Menu.

### macOS Installation
- Open the `.dmg` file you downloaded.
- Drag the heliosphere icon to your Applications folder.
- You can now launch heliosphere from your Applications.
...
## 🎯 Features
- **Open-source:** Feel secure knowing there are no hidden backdoors.
- **Decentralized Energy:** Join a community focused on energy as a commons.
- **Betrayal-proof Design:** Enjoy an infrastructure built on trust.
...
## 📄 License
heliosphere is licensed under the AGPL. You are free to use, modify, and distribute the software, provided that you adhere to the same license conditions.

## ⚙️ Contributing
We welcome contributions. If you have suggestions or would like to report an issue, please create an issue in the GitHub repository. Be sure to check out the contribution guidelines to understand how you can help improve heliosphere.

Thank you for choosing heliosphere and contributing to a brighter energy future!